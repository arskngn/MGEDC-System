                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td align="center" style="vertical-align:top;font-size:0;">
                                                                <a href="#">
                                                                    <img style="display:block; line-height:0px; font-size:0px; border:0px;" src="" width="220" alt="logo">
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="preference-link" align="center" style="font-family: 'Open sans', Arial, sans-serif; color:#95a5a6; font-size:14px;">
                                                                © {{ date('Y') }} <a href="#">{{site_name}}</a>. All Rights Reserved.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td height="10"></td>
...
HTML;
        ...
        \Illuminate\Support\Facades\DB::table('notification_settings')->update([
            'email_body' => $formattedHtml,
            'updated_at' => now(),
        ]);
    }

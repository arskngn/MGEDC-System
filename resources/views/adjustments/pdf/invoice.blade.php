...
<head>
    <meta charset="utf-8">
    <title>Adjustment {{ $adjustment->tracking_no }}</title>
    <style>
        ...
        .type-added { color: #0891b2; font-weight: bold; }
        .type-removed { color: #dc2626; font-weight: bold; }
    </style>
</head>
<body>
    <div class="header">
        ...
        <div class="title-section">
            ...
            <div class="meta"><strong>Tracking No.:</strong> {{ $adjustment->tracking_no }}</div>
            <div class="meta"><strong>Date:</strong> {{ $adjustment->adjustment_date->format('d F Y') }}</div>
            <div class="meta"><strong>Warehouse:</strong> {{ $adjustment->warehouse->name }}</div>
        </div>
    </div>
    ...
    <div class="detail-block">
        ...
        <div style="margin-top: 4px;">{{ $adjustment->note }}</div>
    </div>
    @endif
    ...
    <table class="items">
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="6" style="text-align: center; padding: 12px;">No items found</td>
                </tr>
            @endforelse
        </tbody>
    </table>

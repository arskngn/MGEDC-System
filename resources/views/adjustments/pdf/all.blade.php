...
<body>
    <div class="header">
        <div class="title-section">
            <div class="title">All Adjustments</div>
        ...
        <tbody>
            @forelse($adjustments as $i => $adjustment)
                <tr>
                    ...
                    <td>{{ Illuminate\Support\Str::limit($adjustment->note ?? '—', 30) }}</td>
                </tr>
            @empty
                <tr>
                    <td colspan="6" style="text-align: center; padding: 12px;">No adjustments found</td>
                </tr>
            @endforelse
        </tbody>
    </table>

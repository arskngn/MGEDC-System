    ...
    >
        <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div class="flex flex-wrap items-center gap-2 lg:gap-2 lg:ml-auto lg:justify-end">
                <form id="search-form" ref="filterForm" method="GET" action="{{ route('customer-payments.index') }}" class="inline-flex flex-wrap items-center gap-2" x-data="purchaseDateRange({ dateFrom: '{{ $startDate }}', dateTo: '{{ $endDate }}' })" @keydown.escape.window="escapeClose()">
                    <!-- Filter Dropdown -->
                    <div class="relative">
                        <button
                            type="button"
